...
while count + begin_snap < end_snap:
    ...
    if end:
        ...
        break
    if not end:
        plt.savefig(f'sat_f_avg/{trj.snap.time}.png', dpi=100)
        plt.close()

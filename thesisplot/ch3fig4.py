...
ax.text(
         0.0, 1.0, 'b)', transform=(
            ax.transAxes + ScaledTranslation(-40/72, -10/72, fig.dpi_scale_trans)),
        fontsize=20, va='bottom', fontfamily='serif')
ax1.text(
         0.0, 1.0, 'a)', transform=(
            ax1.transAxes + ScaledTranslation(-40/72, -10/72, fig.dpi_scale_trans)),
        fontsize=20, va='bottom', fontfamily='serif')
